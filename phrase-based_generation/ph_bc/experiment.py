...
if __name__ == '__main__':
    ...
    if args.mode == "experiment1":
        ...
        experiments = [
            ...
            RewardExperimentPhBc(f'text_dir/{args.log_name}_Repeating-A.txt')
        ]
        ...
        experiment = RewardExperimentNoPhBc2(
            f'text_dir/{args.log_name}_reward_no_ph_bc.txt')
        ...
        experiment = RewardExperimentPhBc2(
            f'text_dir/{args.log_name}_reward_only_pop909.txt')
