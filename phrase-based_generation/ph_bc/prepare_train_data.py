...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        with open(f"data_pkl/{dataset['name']}.pkl", "rb") as f:
    ...
    for test_data in test_full_seqs:
        if test_data["seq"] in temp_train_seqs:
            test_full_seqs.remove(test_data)
            print(f"Removed duplicate entry in test full sequences")

    with open(f"data_pkl/train_{args.max_len}.pkl", "wb") as f:
        pickle.dump(train_dataset, f)
    with open(f"data_pkl/test_{args.max_len}.pkl", "wb") as f:
        pickle.dump(test_dataset, f)
    with open(f"data_pkl/train_full_seqs.pkl", "wb") as f:
        pickle.dump(train_full_seqs, f)
    with open(f"data_pkl/test_full_seqs.pkl", "wb") as f:
        pickle.dump(test_full_seqs, f)
