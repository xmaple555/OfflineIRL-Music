...
if __name__ == '__main__':
    ...
    if args.mode == "experiment1":
        ...
        experiment = ProbabilityExperimentNoPhBC(
            f'text_dir/{args.log_name}_prob_reward.txt', generator, myvocab)

        with open("./data_pkl/test_full_seqs.pkl", "rb") as f:
            test_full_seqs = pickle.load(f)


        for i in tqdm(range(len(test_full_seqs))):
            experiment.reward_experiment_fun(test_full_seqs[i]['seq'])
